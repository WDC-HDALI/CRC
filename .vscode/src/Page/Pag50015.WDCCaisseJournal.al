...
page 50015 "WDC Caisse Journal"
{
    ApplicationArea = All;
    CaptionML = ENU = 'Caisse Journal', FRA = 'Journal caisse';
    PageType = Worksheet;
    Editable = true;
    ...
    layout
    {
        area(Content)
        {
            group(Filter)
            {
                ...
                field(StartDateFilter; StartDateFilter)
                {
                    ...
                    begin
                        ...
                        CurrPage."WDC Sales Statistics".Page.SetDateFilter(StartDateFilter, EndDateFilter);
                        CurrPage."WDC Sales Statistics".Page.Update();
            ...
            group(Statistique)
            {
                ...
                ShowCaption = false;
                part("WDC Sales Statistics"; "WDC Sales Statistics")
                {
                    ApplicationArea = All;
                }
            }
    ...
    actions
    {
        area(Navigation)
        {
            ...
            action(PrintCashJournal)
            {
                ...
                // PromotedIsBig = true;
                Image = Print;
                RunObject = report "WDC Cash Journal";
    ...
    begin
        ...
        Rec.SetFilter("Posting Date", '%1..%2', StartDateFilter, EndDateFilter);
        CurrPage."WDC Sales Statistics".Page.SetDateFilter(StartDateFilter, EndDateFilter);
        CurrPage."WDC Sales Statistics".Page.Update(false);
        CurrPage.Update(false);
    end;
