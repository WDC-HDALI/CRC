report 50905 "WDC Upd Customer Entries Effet"
{
    Caption = 'Mise à jour des effets sur Customer Ledger Entries';
    ProcessingOnly = true;
    UsageCategory = Tasks;
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
        {
            ...
            begin
                DescText := "Cust. Ledger Entry"."Description";
            ...
            begin
                Message('Mise à jour des effets sur les Customer Ledger Entries terminée.');
            end;
        }
    }
}
