table 50001 "WDC Customer Shipment Header"
{
    ...
    fields
    {
        ...
        {
            CaptionML = ENU = 'Ship-to Address', FRA = 'Adresse livraison';
            Editable = false;
        }
        field(16; "Ship-to Address 2"; Text[50])
        {
            CaptionML = ENU = 'Ship-to Address 2', FRA = 'Adresse livraison 2';
            Editable = false;
        }
        field(17; "Ship-to City"; Text[30])
        {
            CaptionML = ENU = 'Ship-to City', FRA = 'Ville livraison';
            TableRelation = "Post Code".City;
            ValidateTableRelation = false;
            Editable = false;
        }
        ...
        {
            CaptionML = ENU = 'Sell-to Customer Name', FRA = 'Nom client';
            Editable = false;
        }
        ...
        {
            CaptionML = ENU = 'Ship-to Post Code', FRA = 'Code postal livraison';
            TableRelation = "Post Code";
            ValidateTableRelation = false;
            Editable = false;
        }
...
#pragma warning restore AS0086
        ...
        field(50600; "Document Date"; Date)
        {
            CaptionML = ENU = 'Document Date', FRA = 'Date document';
            Editable = false;
        }
        field(50601; Status; Enum "WDC Customer Delivery Status")
        {
