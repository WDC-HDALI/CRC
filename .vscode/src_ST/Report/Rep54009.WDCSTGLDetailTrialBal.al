report 54009 "WDC-ST G/L Detail Trial Bal."
{
    DefaultLayout = RDLC;
    RDLCLayout = './.vscode/src_ST/report/RDLC/GLDetailTrialBalance.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'WDC Grand Livre Comptes genéraux';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                FiscalYearStatusText := StrSubstNo(Text012, STFiscalYearFiscalClose.CheckFiscalYearStatus(GetFilter("Date Filter")));
    ...
    var
        ...
        Period: Record Date;
        STFiscalYearFiscalClose: Codeunit "WDC-ST Fiscal Year FiscalClose";
        DateFilterCalc: Codeunit "WDC-ST DateFilter-Calc";
        StartDate: Date;
        EndDate: Date;
