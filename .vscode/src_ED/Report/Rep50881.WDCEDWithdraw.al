report 50881 "WDC-ED Withdraw"
{
    captionML = ENU = 'Withdraw', FRA = 'Prélèvement';
    ProcessingOnly = true;
    ...
    var
        ...
        Text008: TextConst ENU = 'Bank Account No. %1 is too long. Please verify before continuing.',
                           FRA = 'Le n° de compte bancaire %1 est trop long. Vérifiez-le avant de continuer.';
        Text009: TextConst ENU = 'The RIB of bank account %1 of customer %2 is incorrect. Please verify before continuing.',
                           FRA = 'Le RIB du compte bancaire %1 du client %2 est erroné. Vérifiez-le avant de continuer.';
        Text010: TextConst ENU = 'All withdraws must refer to the same currency.',
                           FRA = 'Tous les prélèvements doivent être liés à la même devise.';
        Text011: TextConst ENU = 'All withdraws must have the same due date.',
                           FRA = 'Tous les prélèvements doivent avoir la même date d''échéance';
        Text012: TextConst ENU = 'All withdraws must have the same document number.',
                           FRA = 'Tous les prélèvements doivent avoir le même n° de document.';
        Text013: TextConst ENU = 'default.txt',
                           FRA = 'default.txt';
        Text014: TextConst ENU = 'Text Files|*.txt|All Files|*.*',
