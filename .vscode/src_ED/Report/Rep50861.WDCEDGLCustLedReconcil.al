report 50861 "WDC-ED GL/Cust. Led. Reconcil."
{
    DefaultLayout = RDLC;
    RDLCLayout = './.vscode/src_ED/report/RDLC/GLCustLedgerReconciliation.rdlc';
    ApplicationArea = All;
    captionML = ENU = 'GL/Cust. Ledger Reconciliation', FRA = 'Rapprochement cpta. gén./client';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Group ID") WHERE(Amount = FILTER(<> 0));
    ...
    var
        ...
        General_Customer_ledger_reconciliationCaptionLbl: TextConst ENU = 'General/Customer ledger reconciliation',
                                                                    FRA = 'Rapprochement cpta. gén./clt';
        ...
        General_AmountCaptionLbl: TextConst ENU = 'General Amount',
                                            FRA = 'Montant général';
        Total_amount_for_the_customerCaptionLbl: TextConst ENU = 'Total amount for the customer',
                                                           FRA = 'Montant total pour le client';
        Total_amount_for_the_general_ledgerCaptionLbl: TextConst ENU = 'Total amount for the general ledger',
                                                                 FRA = 'Total amount for the general ledger';
        General_amount_for_the_general_ledgerCaptionLbl: TextConst ENU = 'General amount for the general ledger',
                                                                   FRA = 'Montant général pour la comptabilité';
}
