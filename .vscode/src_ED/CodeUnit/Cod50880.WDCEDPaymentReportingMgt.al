codeunit 50880 "WDC-ED Payment Reporting Mgt."
{
    ...
    procedure BuildVendPmtApplicationBuffer(var TempPaymentApplicationBuffer: Record "WDC-ED Pay. Application Buffer" temporary; StartingDate: Date; EndingDate: Date; PaymentsWithinPeriod: Boolean)
    var
    ...
    procedure BuildCustPmtApplicationBuffer(var TempPaymentApplicationBuffer: Record "WDC-ED Pay. Application Buffer" temporary; StartingDate: Date; EndingDate: Date; PaymentsWithinPeriod: Boolean)
    var
    ...
    procedure GetTotalAmount(var TempPaymentApplicationBuffer: Record "WDC-ED Pay. Application Buffer" temporary): Decimal
    begin
    ...
    procedure PrepareNotPaidInDaysSource(var TempPaymentApplicationBuffer: Record "WDC-ED Pay. Application Buffer" temporary; DaysFrom: Integer; DaysTo: Integer): Boolean
    begin
        TempPaymentApplicationBuffer.Reset();
    ...
    procedure PrepareDelayedPmtInDaysSource(var TempPaymentApplicationBuffer: Record "WDC-ED Pay. Application Buffer" temporary; DaysFrom: Integer; DaysTo: Integer): Boolean
    begin
        TempPaymentApplicationBuffer.Reset();
    ...
    procedure GetPctOfPmtsNotPaidInDays(var TempPaymentApplicationBuffer: Record "WDC-ED Pay. Application Buffer" temporary; TotalAmount: Decimal): Decimal
    begin
    ...
    procedure GetPctOfPmtsDelayedInDays(var TempPaymentApplicationBuffer: Record "WDC-ED Pay. Application Buffer" temporary; TotalAmount: Decimal): Decimal
    begin
        if TotalAmount = 0 then
            exit(0);
